...
Sabuhi Nazarov led implementation refactoring, experiment orchestration, containerized reproducibility, and primary synthetic runs. Agshin Fataliyev led Track A implementation and analysis (SVD/PCA workflow, scree/2D interpretation, and dimensionality comparison summary), and contributed to broader result interpretation and report integration.
